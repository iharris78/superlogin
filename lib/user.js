...
module.exports = function (config, userDB, couchAuthDB, mailer, emitter, onCreateActions, onLinkActions, adapter) {
  ...
  this.create = function (form, req) {
    ...
    return user.process()
      ...
      .then(function () {
        emitter.emit('signup', newUser, 'local', req.headers.realm);
  ...
  this.createSession = function(user_id, realm, provider, req) {
    var user;
    var newToken;
    var newSession;
    var password;
